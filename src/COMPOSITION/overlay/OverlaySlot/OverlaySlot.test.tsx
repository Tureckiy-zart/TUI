...
describe("OverlaySlot", () => {
  ...
  describe("Single Anchor enforcement", () => {
    ...
    it("renders new Anchor when swapping (conditional content or key change)", () => {
      const { rerender } = render(
        <OverlaySlot.Root>
          <OverlaySlot.Anchor>First anchor</OverlaySlot.Anchor>
        </OverlaySlot.Root>,
      );
      ...
      rerender(
        <OverlaySlot.Root>
          <OverlaySlot.Anchor>Second anchor</OverlaySlot.Anchor>
        </OverlaySlot.Root>,
      );
      expect(screen.queryByText("First anchor")).not.toBeInTheDocument();
      expect(screen.getByText("Second anchor")).toBeInTheDocument();
    });
