 ...
 * EventCard Variants
 *
 * TokenCVA-based variant system for EventCard component.
 ...
 */
export const eventCardVariants = tokenCVA({
  ...
  variants: {
    ...
    } satisfies Record<EventCardSize, string>,
    layout: {
      vertical: "flex flex-col",
    } satisfies Record<EventCardLayout, string>,
    variant: {
      default: "",
      featured: `${DOMAIN_TOKENS.badges.surface.featured}`,
    } satisfies Record<EventCardVariant, string>,
  },
  defaultVariants: {
    size: "default",
    layout: "vertical",
 ...
 */
export const eventCardBadgeVariants = tokenCVA({
  base: "absolute z-10",
  variants: {
    size: {
 ...
 */
export const eventCardBadgeSurfaceVariants = tokenCVA({
 ...
 */
export const eventCardMetadataVariants = tokenCVA({
  base: `flex flex-col ${DOMAIN_TOKENS.metadata.spacing.vertical}`,
  variants: {
    size: {
      default: "",
      compact: "",
 ...
 */
export const eventCardMetadataItemVariants = tokenCVA({
 ...
 */
export const eventCardMetadataIconVariants = tokenCVA({
  base: `${DOMAIN_TOKENS.metadata.icon.sizeSm} ${DOMAIN_TOKENS.metadata.icon.default}`,
  variants: {
    size: {
      default: "",
      compact: "",
 ...
 */
export const eventCardTicketButtonVariants = tokenCVA({
  base: `inline-flex items-center justify-center ${DOMAIN_TOKENS.badges.surface.featured} ${DOMAIN_TOKENS.badges.text.color} ${DOMAIN_TOKENS.badges.shadow} ${DOMAIN_TOKENS.motion.hover.transition} ${TEXT_TOKENS.fontWeight.semibold} transform`,
  variants: {
    size: {
 ...
 */
export const eventCardTicketButtonIconVariants = tokenCVA({
  base: `${DOMAIN_TOKENS.metadata.icon.sizeSm} ${DOMAIN_TOKENS.spacing.button.iconMarginLeft}`,
  variants: {
    size: {
      default: "",
      compact: "",
 ...
 */
export const eventCardPriceVariants = tokenCVA({
  base: GRADIENT_TOKENS.text.brand,
  variants: {
    size: {
