...
export const textColors: Record<Mode, TextColors> = {
  day: {
    ...
    tertiary: "0 0% 42%", // Light gray - adjusted for WCAG AA contrast (4.5:1) on all light surfaces including elevated
  ...
  night: {
    ...
    tertiary: "240 5% 53%", // Darker gray - adjusted for WCAG AA contrast (4.5:1) on dark elevated surfaces
