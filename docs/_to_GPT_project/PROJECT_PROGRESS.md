...
- ✅ `docs/architecture/TYPOGRAPHY_AUTHORITY_CONTRACT.md` - Added reference with note about separation from typography scale
- ✅ `docs/architecture/SPACING_AUTHORITY_CONTRACT.md` - Added reference with note about interactive components using spacing tokens via size prop
- ✅ `docs/architecture/LAYOUT_AUTHORITY_CONTRACT.md` - Added reference with note about non-interactive components not using size prop
- ✅ `docs/architecture/INTERACTION_AUTHORITY_CONTRACT.md` - Added reference in Related Documents
- ✅ `docs/architecture/STATE_AUTHORITY_CONTRACT.md` - Added reference in Related Documents
- ✅ `docs/architecture/STATE_AUTHORITY_MATRIX.md` - Added reference in Related Documents
