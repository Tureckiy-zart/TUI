...
- **MUST demonstrate asChild usage** (if component supports `asChild` prop) — **NOTE:** Link component does NOT support `asChild` (see [LINK_NO_ASCHILD_CANONICAL_ANCHOR.md](./LINK_NO_ASCHILD_CANONICAL_ANCHOR.md))
...
- [ ] **asChild Usage:** asChild composition pattern is demonstrated (if component supports `asChild`) — **NOTE:** Link component does NOT support `asChild` (see [LINK_NO_ASCHILD_CANONICAL_ANCHOR.md](./LINK_NO_ASCHILD_CANONICAL_ANCHOR.md))
