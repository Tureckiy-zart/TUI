...
| **Layout Authority** | Layout | Layout structure and flow (WHERE elements are positioned) | Layout | ✅ LOCKED | [LAYOUT_AUTHORITY_CONTRACT.md](./LAYOUT_AUTHORITY_CONTRACT.md) |
