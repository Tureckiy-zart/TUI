...
| `docs/INTERNAL_CANONICAL_CONTEXT.md` | LAW | IMMUTABLE | 1448 | Single source of truth for architecture, design decisions, Foundation vs Extension rules |
| `docs/architecture/FINAL_FOUNDATION_LOCK.md` | LAW | LOCKED | 1860 | Authoritative Foundation lock status - source of truth for locked Foundation layer |
| `docs/CANONICAL_PROJECT_ORIENTATION.md` | SNAPSHOT | ACTIVE | 400 | Canonical project orientation - documents PostCSS/Tailwind fix |
| **AUTHORITY CONTRACTS (LAW)** |||||
| `docs/architecture/INTERACTION_AUTHORITY_CONTRACT.md` | LAW | LOCKED | 567 | Interaction state activation rules, priority order, blocking rules |
| `docs/architecture/STATE_AUTHORITY_MATRIX.md` | LAW | LOCKED | 645 | Canonical state set definition (base, hover, active, focus-visible, disabled, loading) |
| `docs/architecture/STATE_AUTHORITY_CONTRACT.md` | LAW | LOCKED | 644 | State token model, naming rules, property mapping |
| `docs/architecture/SPACING_AUTHORITY_CONTRACT.md` | LAW | LOCKED | 400 | Canonical spacing scale, component rules, forbidden patterns |
| `docs/architecture/RADIUS_AUTHORITY_CONTRACT.md` | LAW | LOCKED | 350 | Canonical radius scale, component standards, forbidden patterns |
| `docs/architecture/TYPOGRAPHY_AUTHORITY_CONTRACT.md` | LAW | LOCKED | 450 | Canonical typography scale, semantic roles, forbidden patterns |
| `docs/architecture/MOTION_AUTHORITY_CONTRACT.md` | LAW | LOCKED | 380 | Canonical motion tokens, durations, easings, forbidden patterns |
| `docs/architecture/ELEVATION_AUTHORITY_CONTRACT.md` | LAW | LOCKED | 350 | Canonical elevation tokens, z-index scale, forbidden patterns |
| `docs/architecture/LAYOUT_AUTHORITY_CONTRACT.md` | LAW | LOCKED | 618 | Canonical layout primitives, separation laws, forbidden patterns |
...
| `docs/architecture/TOKEN_SYSTEM.md` | LAW | LOCKED | 612 | Token system definition, ownership rules, semantic classifications |
| `docs/architecture/EXTENSION_AUTHORITY_CONTRACT.md` | LAW | ACTIVE | 628 | Extension layer boundary contract |
| **AUTHORITY NAVIGATION (META)** |||||
| `docs/architecture/AUTHORITY_MAP.md` | META | ACTIVE | 382 | Navigation map for Authority system - mental model |
| **ARCHITECTURE RULES & LOCKS (GUIDE/LAW)** |||||
| `docs/architecture/CANONICAL_LOCK.md` | LAW | LOCKED | 431 | Canonical architecture lock - authoritative source for canonical state and forbidden regressions |
| `docs/architecture/UI_ARCHITECTURE_LOCK.md` | LAW | LOCKED | 770 | **PRIMARY CANONICAL SOURCE** - UI architecture lock with all canonical rules and implementations |
| `docs/architecture/CANONICAL_STATE_FINAL.md` | SNAPSHOT | ARCHIVED | 40 | ⚠️ **ARCHIVED/SUPERSEDED** - Final truth snapshot (superseded by UI_ARCHITECTURE_LOCK.md) |
| `docs/architecture/EXTENSION_CANONICAL_STATE.md` | SNAPSHOT | ACTIVE | 819 | Extension layer canonical state - Extension layer reference |
| `docs/architecture/UI_ARCHITECTURE_RULES.md` | GUIDE | ACTIVE | 981 | UI architecture rules - Architecture rules reference |
| `docs/architecture/TUI_CURSOR_GUARD_RULES.md` | GUIDE | ACTIVE | 1092 | Cursor guard rules - Guard rules reference |
| `docs/architecture/CURSOR_UI_RULES.md` | GUIDE | ACTIVE | 1050 | Cursor AI rules for UI development - Cursor-specific rules |
| `docs/architecture/LINTING_RULES.md` | GUIDE | ACTIVE | 200 | Linting standards and rules - Linting reference |
...
| `docs/structure/TYPING_STANDARD.md` | GUIDE | ACTIVE | 400 | Typing standards - Typing reference |
...
| **CI/CD (GUIDE)** |||||
| `docs/CI-CD_OVERVIEW.md` | GUIDE | ACTIVE | 300 | CI/CD overview - CI/CD reference |
...
**Documents:**
1. `docs/architecture/TUI_CURSOR_GUARD_RULES.md` (1092 lines)
2. `docs/architecture/CURSOR_UI_RULES.md` (1050 lines)
3. `docs/architecture/UI_ARCHITECTURE_RULES.md` (981 lines)
...
**Overlapping Content:**
- **Foundation Authority Protection Rules**: Stated in TUI_CURSOR_GUARD_RULES.md, CURSOR_UI_RULES.md, and UI_ARCHITECTURE_RULES.md
- **Token Union Rules**: Stated in CURSOR_UI_RULES.md and UI_ARCHITECTURE_RULES.md
- **Component Lifecycle**: Stated in TUI_CURSOR_GUARD_RULES.md and component-lifecycle.mdc
- **Scope Enforcement**: Stated in TUI_CURSOR_GUARD_RULES.md and block-and-scope-rules.mdc
- **Rule Resolution Order**: Stated in user-rules.mdc and CURSOR_RULES_RESOLUTION_ORDER.mdc

**Source of Truth:**
- **TUI_CURSOR_GUARD_RULES.md**: Most comprehensive, should be primary source
- **CURSOR_UI_RULES.md**: Focuses on token union rules, can reference TUI_CURSOR_GUARD_RULES.md
- **UI_ARCHITECTURE_RULES.md**: Focuses on Radix UI boundaries, can reference TUI_CURSOR_GUARD_RULES.md
- **.cursor/rules/*.mdc**: Should reference canonical docs, not duplicate content

**Compression Action:** **SHRINK + REFERENCE**
- Keep TUI_CURSOR_GUARD_RULES.md as primary source
- Reduce CURSOR_UI_RULES.md and UI_ARCHITECTURE_RULES.md to domain-specific content only
...
**Documents:**
1. `docs/architecture/FINAL_FOUNDATION_LOCK.md` (1860 lines) - **PRIMARY SOURCE**
2. `docs/architecture/UI_ARCHITECTURE_LOCK.md` (770 lines)
3. `docs/architecture/CANONICAL_LOCK.md` (431 lines)
...
- **Foundation Component List**: Stated in FINAL_FOUNDATION_LOCK.md and UI_ARCHITECTURE_LOCK.md
- **Canonical Layer Definitions**: Stated in CANONICAL_LOCK.md and UI_ARCHITECTURE_LOCK.md
- **Foundation Rules**: Stated in all three active documents

**Source of Truth:**
- **FINAL_FOUNDATION_LOCK.md**: Authoritative source for Foundation lock status (explicitly stated in document)
- **UI_ARCHITECTURE_LOCK.md**: Authoritative source for UI architecture lock (explicitly stated in document)
- **CANONICAL_LOCK.md**: Authoritative source for canonical layer definitions
...
**Documents:**
1. `docs/INTERNAL_CANONICAL_CONTEXT.md` (1448 lines) - **PRIMARY SOURCE**
2. `docs/_to_GPT_project/INTERNAL_CANONICAL_CONTEXT.md` (1448 lines) - Copy
3. `docs/_to_GPT_project_essential/INTERNAL_CANONICAL_CONTEXT.md` (1448 lines) - Copy
4. `docs/gpt_canon_context/GPT_PROJECT_SCOPE.md` (100 lines) - Related but different

**Finding:** Files in `_to_GPT_project` directories are copies, not duplicates. The canonical source is `docs/INTERNAL_CANONICAL_CONTEXT.md`.
...
**TUI_CURSOR_GUARD_RULES.md (1092 lines) - PRIMARY SOURCE**
...
**CURSOR_UI_RULES.md (1050 lines) - TOKEN UNION FOCUS**
...
- **Overlap with TUI_CURSOR_GUARD_RULES.md**: 
  - Foundation Authority status mentioned but not detailed
  - Token rules overlap with TUI_CURSOR_GUARD_RULES.md Token System Rules section

**UI_ARCHITECTURE_RULES.md (981 lines) - RADIX UI FOCUS**
...
- **Token Union Rules** (lines 191-400): Token union rules (overlaps with CURSOR_UI_RULES.md)
- **Overlap with TUI_CURSOR_GUARD_RULES.md**:
  - Foundation Authority status mentioned but not detailed
  - Token rules overlap with TUI_CURSOR_GUARD_RULES.md Token System Rules section
...
|------------|------------|----------------------------|-------------------------|----------------|
| TUI_CURSOR_GUARD_RULES.md | CURSOR_UI_RULES.md | Foundation Authority Protection Rules | TUI_CURSOR_GUARD_RULES.md (lines 69-122) | TUI_CURSOR_GUARD_RULES.md |
| TUI_CURSOR_GUARD_RULES.md | CURSOR_UI_RULES.md | Token System Rules | TUI_CURSOR_GUARD_RULES.md (lines 273-456) | TUI_CURSOR_GUARD_RULES.md |
| TUI_CURSOR_GUARD_RULES.md | UI_ARCHITECTURE_RULES.md | Foundation Authority Protection Rules | TUI_CURSOR_GUARD_RULES.md (lines 69-122) | TUI_CURSOR_GUARD_RULES.md |
| TUI_CURSOR_GUARD_RULES.md | UI_ARCHITECTURE_RULES.md | Token System Rules | TUI_CURSOR_GUARD_RULES.md (lines 273-456) | TUI_CURSOR_GUARD_RULES.md |
| CURSOR_UI_RULES.md | UI_ARCHITECTURE_RULES.md | Token Union Typing Rules | Both have similar content | Keep both, but reference TUI_CURSOR_GUARD_RULES.md for Foundation rules |
| FINAL_FOUNDATION_LOCK.md | UI_ARCHITECTURE_LOCK.md | Foundation Component List | FINAL_FOUNDATION_LOCK.md (authoritative) | FINAL_FOUNDATION_LOCK.md |
| FINAL_FOUNDATION_LOCK.md | UI_ARCHITECTURE_LOCK.md | Foundation Lock Status | FINAL_FOUNDATION_LOCK.md (explicitly stated as source of truth) | FINAL_FOUNDATION_LOCK.md |
| CANONICAL_LOCK.md | UI_ARCHITECTURE_LOCK.md | Canonical Layer Definitions | CANONICAL_LOCK.md (focused on layers) | CANONICAL_LOCK.md |
| CANONICAL_STATE_FINAL.md | UI_ARCHITECTURE_LOCK.md | All content | UI_ARCHITECTURE_LOCK.md (explicitly supersedes) | UI_ARCHITECTURE_LOCK.md |
| INTERNAL_CANONICAL_CONTEXT.md | _to_GPT_project/INTERNAL_CANONICAL_CONTEXT.md | All content | docs/INTERNAL_CANONICAL_CONTEXT.md (canonical) | docs/INTERNAL_CANONICAL_CONTEXT.md |
...
| FINAL_FOUNDATION_LOCK.md | _to_GPT_project/FINAL_FOUNDATION_LOCK.md | All content | docs/architecture/FINAL_FOUNDATION_LOCK.md (canonical) | docs/architecture/FINAL_FOUNDATION_LOCK.md |
...
- Content merged into UI_ARCHITECTURE_LOCK.md
- No longer serves a purpose

**Impact:**
- Files removed: 1
- Lines removed: 40
- Information preserved: 100% (already in UI_ARCHITECTURE_LOCK.md)

### 3.3 SHRINK Proposals

#### SHRINK-1: Reduce `docs/architecture/CURSOR_UI_RULES.md`

**Current:** 1050 lines  
**Proposed:** ~400 lines (60% reduction)

**Actions:**
- Remove Foundation Authority Protection Rules section (reference TUI_CURSOR_GUARD_RULES.md)
- Keep only token union-specific rules
- Add explicit references to TUI_CURSOR_GUARD_RULES.md for Foundation rules

**Impact:**
- Lines reduced: ~650
- Cognitive load: Clearer focus on token union rules

#### SHRINK-2: Reduce `docs/architecture/UI_ARCHITECTURE_RULES.md`
...
- `docs/architecture/UI_ARCHITECTURE_LOCK.md`
- `docs/architecture/CANONICAL_LOCK.md`

**Actions:**
- Add explicit "See also" sections in each document
- Clarify separation of concerns
- Remove duplicated Foundation component lists (reference FINAL_FOUNDATION_LOCK.md)
...
2. `docs/architecture/FINAL_FOUNDATION_LOCK.md` - Foundation lock status
3. All 12 Authority Contracts in `docs/architecture/` - Immutable domain rules
4. `docs/architecture/UI_ARCHITECTURE_LOCK.md` - UI architecture lock
5. `docs/architecture/CANONICAL_LOCK.md` - Canonical layer definitions
...
1. `docs/architecture/TUI_CURSOR_GUARD_RULES.md` - Primary guard rules (SHRUNK)
2. `docs/architecture/CURSOR_UI_RULES.md` - Token union rules (SHRUNK)
3. `docs/architecture/UI_ARCHITECTURE_RULES.md` - Radix UI boundaries (SHRUNK)
4. `docs/architecture/EXTENSION_CANONICAL_STATE.md` - Extension state
5. `docs/architecture/LINTING_RULES.md` - Linting rules
...
8. `docs/structure/TYPING_STANDARD.md` - Typing standard
...
1. `docs/CANONICAL_PROJECT_ORIENTATION.md` - Project orientation
...
1. `docs/architecture/AUTHORITY_MAP.md` - Authority navigation
...
- ⚠️ Some documents still long (FINAL_FOUNDATION_LOCK.md at 1860 lines)
...
4. **Remove `docs/architecture/CANONICAL_STATE_FINAL.md`**
   ...
   - Verify content in UI_ARCHITECTURE_LOCK.md
   - Remove file

### Phase 2: SHRINK Operations (Medium Risk)

1. **SHRINK `docs/architecture/CURSOR_UI_RULES.md`**
   - Remove Foundation Authority Protection Rules section
   - Add reference to TUI_CURSOR_GUARD_RULES.md
   - Keep only token union-specific content

2. **SHRINK `docs/architecture/UI_ARCHITECTURE_RULES.md`**
   - Remove Foundation Authority Protection Rules section
   - Add reference to TUI_CURSOR_GUARD_RULES.md
...
1. **Add cross-references to lock documents**
   - Update FINAL_FOUNDATION_LOCK.md with "See also" section
   - Update UI_ARCHITECTURE_LOCK.md with "See also" section
   - Update CANONICAL_LOCK.md with "See also" section
...
1. **Consider splitting FINAL_FOUNDATION_LOCK.md** - Currently 1860 lines, could be split by domain
