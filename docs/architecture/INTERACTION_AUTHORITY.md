...
- **WHAT states exist** - The canonical state set (base, hover, active, focus-visible, disabled, loading) is defined in [STATE_AUTHORITY_MATRIX.md](./STATE_AUTHORITY_MATRIX.md)
- **HOW states are represented** - State token format, structure, and naming rules are defined in [STATE_AUTHORITY_CONTRACT.md](./STATE_AUTHORITY_CONTRACT.md)
...
**Note:** For enforcement mechanisms, see [INTERACTION_AUTHORITY_GUARD_LAYER.md](./INTERACTION_AUTHORITY_GUARD_LAYER.md). For verification protocols, see [INTERACTION_AUTHORITY_HOVER_VERIFICATION.md](./INTERACTION_AUTHORITY_HOVER_VERIFICATION.md).
