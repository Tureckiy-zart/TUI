...
|-----------|--------|---------------|-------|--------|-------------------|
| **State Authority Matrix** | State | **WHAT** states exist (canonical state set) | WHAT | ✅ LOCKED | [STATE_MATRIX.md](./STATE_MATRIX.md) |
| **Interaction Authority** | Interaction | **WHEN** states activate (activation rules) | WHEN | ✅ LOCKED | [INTERACTION_AUTHORITY.md](./INTERACTION_AUTHORITY.md) |
| **State Authority Contract** | State | **HOW** states are represented (token format) | HOW | ✅ LOCKED | [STATE_AUTHORITY.md](./STATE_AUTHORITY.md) |
| **Spacing Authority** | Spacing | Spacing token usage (padding, margin, gap) | Token | ✅ ACTIVE | [SPACING_AUTHORITY.md](./SPACING_AUTHORITY.md) |
| **Radius Authority** | Radius | Border radius token usage | Token | ✅ ACTIVE | [RADIUS_AUTHORITY.md](./RADIUS_AUTHORITY.md) |
| **Typography Authority** | Typography | Typography token usage (font, size, weight) | Token | ✅ ACTIVE | [TYPOGRAPHY_AUTHORITY.md](./TYPOGRAPHY_AUTHORITY.md) |
| **Motion Authority** | Motion | Motion token usage (duration, easing, transitions) | Token | ✅ ACTIVE | [MOTION_AUTHORITY.md](./MOTION_AUTHORITY.md) |
...
| "What size should my interactive component use?" | **Interactive Size Scale Authority** | Defines canonical interactive size scale (sm, md, lg) for interactive components |
...
- Reference: [STATE_MATRIX.md](./STATE_MATRIX.md)
...
- Reference: [INTERACTION_AUTHORITY.md](./INTERACTION_AUTHORITY.md)
...
- Reference: [STATE_AUTHORITY.md](./STATE_AUTHORITY.md)
...
- Reference: [SPACING_AUTHORITY.md](./SPACING_AUTHORITY.md)
...
- Reference: [RADIUS_AUTHORITY.md](./RADIUS_AUTHORITY.md)
...
- Reference: [TYPOGRAPHY_AUTHORITY.md](./TYPOGRAPHY_AUTHORITY.md)
...
- Reference: [MOTION_AUTHORITY.md](./MOTION_AUTHORITY.md)
...
- Reference: [ELEVATION_AUTHORITY.md](./ELEVATION_AUTHORITY.md)
...
### 4. Interactive Authorities (Size Scale)

**Step 10: Interactive Size Scale Authority**
- Determine interactive size scale for interactive components
...
- [State Authority Matrix](./STATE_MATRIX.md) - WHAT states exist
- [Interaction Authority](./INTERACTION_AUTHORITY.md) - WHEN states activate
- [State Authority](./STATE_AUTHORITY.md) - HOW states are represented
...
- [Final Foundation Lock](./FOUNDATION_LOCK.md) - Foundation layer lock status
...
- [Button Component](../../src/PRIMITIVES/Button/Button.tsx) - Canonical reference implementation
...
- **v1.1** (2025-12-18): Interactive Size Scale Authority Integration
  ...
  - Added Interactive Size Scale Authority to Authority Resolution Order (Step 10)
  - Added Interactive Size Scale Authority to Related Documents
  - Updated Layout Authority status from ACTIVE to LOCKED
  - Completed integration per TUNG_ARCH_LOCK: INTERACTIVE_SIZE_SCALE_CANONICALIZATION task
