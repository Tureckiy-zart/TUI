...
**Authority:** This contract is enforced by [FOUNDATION_LOCK.md](./FOUNDATION_LOCK.md) and implemented through Phase 3 and Phase 4 enforcement mechanisms documented in:
...
**Unlock Procedure:** Any changes to Foundation enforcement require explicit unlock procedure as documented in [FOUNDATION_LOCK.md](./FOUNDATION_LOCK.md).
...
**Authority:** [FOUNDATION_LOCK.md](./FOUNDATION_LOCK.md) - Foundation Enforcement Lock Status
...
- **[FOUNDATION_LOCK.md](./FOUNDATION_LOCK.md)** - Defines which components are Foundation, their lock status, and **Foundation Enforcement Lock Status** (authority for enforcement)
...
- **[UI_STYLING_ESCAPE_HATCHES_REPORT.md](../reports/audit/UI_STYLING_ESCAPE_HATCHES_REPORT.md)** - Documents historical state of escape hatches (pre-enforcement)
