...
**This document defines HOW states are represented.** What states exist is defined in [STATE_AUTHORITY_MATRIX.md](./STATE_AUTHORITY_MATRIX.md). When states can activate is defined in [INTERACTION_AUTHORITY_CONTRACT.md](./INTERACTION_AUTHORITY_CONTRACT.md).
...
- Which states exist (see [STATE_AUTHORITY_MATRIX.md](./STATE_AUTHORITY_MATRIX.md))
- When states activate (see [INTERACTION_AUTHORITY_CONTRACT.md](./INTERACTION_AUTHORITY_CONTRACT.md))
...
The canonical set of states is defined in [STATE_AUTHORITY_MATRIX.md](./STATE_AUTHORITY_MATRIX.md). This document does not duplicate that definition.
...
**Activation Rules:** Interaction states are controlled by the [Interaction Authority Contract](./INTERACTION_AUTHORITY_CONTRACT.md), which defines WHEN these states can activate, their activation conditions, and blocking rules.
...
**Reference:** For state semantics and priority rules, see [STATE_AUTHORITY_MATRIX.md](./STATE_AUTHORITY_MATRIX.md). For state activation rules, see [INTERACTION_AUTHORITY_CONTRACT.md](./INTERACTION_AUTHORITY_CONTRACT.md).
...
**Reference:** For detailed state semantics and priority rules, see [STATE_AUTHORITY_MATRIX.md](./STATE_AUTHORITY_MATRIX.md). For state applicability rules (mandatory vs optional), see [State Applicability Rules](#state-applicability-rules) above.
...
**Reference:** Detailed state semantics, priority rules, and suppression rules are defined in [STATE_AUTHORITY_MATRIX.md](./STATE_AUTHORITY_MATRIX.md). State activation conditions (WHEN states can activate) are defined in [INTERACTION_AUTHORITY_CONTRACT.md](./INTERACTION_AUTHORITY_CONTRACT.md).
...
**This document does NOT define:**
- When states can activate (see [INTERACTION_AUTHORITY_CONTRACT.md](./INTERACTION_AUTHORITY_CONTRACT.md))
