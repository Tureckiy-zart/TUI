...
| TOKEN_SYSTEM.md | Token System | ✅ LOCKED | IMMUTABLE | Yes |
...
- Reference: docs/architecture/TOKEN_SYSTEM.md
...
**Reference:** [Token System Documentation](./TOKEN_SYSTEM.md)  
...
- **[Architecture Lock](./UI_ARCHITECTURE_LOCK.md)** — Detailed architecture rules and guidelines
- **[Token System](./TOKEN_SYSTEM.md)** — 🔒 **LOCKED** Token system documentation
