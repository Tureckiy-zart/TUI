...
- Token System rules (see [TOKEN_SYSTEM.md](./TOKEN_SYSTEM.md))
...
- Which Extension components are allowed (see [EXTENSION_CANONICAL_STATE.md](./EXTENSION_CANONICAL_STATE.md))
...
- **[Token System](./TOKEN_SYSTEM.md)** - Token system documentation
- **[UI Architecture Rules](./UI_ARCHITECTURE_RULES.md)** - Radix UI and Token Union rules
- **[Extension Canonical State](./EXTENSION_CANONICAL_STATE.md)** - Allowed Extension components
