...
- **v1.0** (2025-12-16): Initial Spacing Authority Contract definition
...
- `docs/architecture/LAYOUT_AUTHORITY.md` - Layout rules (layout uses spacing tokens)
- `docs/architecture/FOUNDATION_LOCK.md` - Foundation lock status (Spacing Authority Lock Status section)
