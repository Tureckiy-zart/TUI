...
- Interaction Authority rules (see [INTERACTION_AUTHORITY.md](./INTERACTION_AUTHORITY.md))
- State Authority rules (see [STATE_AUTHORITY.md](./STATE_AUTHORITY.md))
- Token System rules (see [TOKEN_AUTHORITY.md](./TOKEN_AUTHORITY.md))
- Layout Authority rules (see [LAYOUT_AUTHORITY.md](./LAYOUT_AUTHORITY.md))
...
- Which Extension components are allowed (see [EXTENSION_STATE.md](./EXTENSION_STATE.md))
...
- **[Final Foundation Lock](./FOUNDATION_LOCK.md)** - Foundation layer lock status (includes Foundation Enforcement Lock Status)
...
- **[Interaction Authority Contract](./INTERACTION_AUTHORITY.md)** - Interaction state rules
- **[State Authority Contract](./STATE_AUTHORITY.md)** - State token model
- **[State Authority Matrix](./STATE_MATRIX.md)** - Canonical state set
- **[Layout Authority Contract](./LAYOUT_AUTHORITY.md)** - Layout rules
- **[Interactive Size Scale Authority Contract](./INTERACTIVE_SIZE_SCALE_AUTHORITY_CONTRACT.md)** - Interactive size scale rules
...
- **[Extension Canonical State](./EXTENSION_STATE.md)** - Allowed Extension components
