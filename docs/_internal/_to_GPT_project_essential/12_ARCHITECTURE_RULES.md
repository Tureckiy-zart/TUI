...
> ⚠️ **FOUNDATION CLOSED**: Foundation Authorities are **CLOSED** and **IMMUTABLE** as of 2025-12-16. All Foundation Authority Contracts (Interaction, State, Layout, Token, Spacing, Radius, Typography, Motion, Elevation) are **LOCKED**. **Foundation Enforcement** (className/style exclusion) is **LOCKED / APPLIED** as of 2025-12-18. See [Token System Lock](#-token-system-lock-status) section below and [FOUNDATION_LOCK.md](./FOUNDATION_LOCK.md) for complete Foundation lock status.
...
**REQUIRED Pattern (see `docs/reference/TYPING_STANDARD.md`):**
...
**Reference:** For complete public API typing rules, see `docs/reference/TYPING_STANDARD.md` (MANDATORY architectural standard). For general TypeScript implementation guidance, see `docs/reference/TYPESCRIPT_GENERAL_RULES.md` (secondary, does not override `TYPING_STANDARD.md`).
...
**Reference:** For complete public API typing rules, see `docs/reference/TYPING_STANDARD.md` (MANDATORY architectural standard).
...
- **Foundation Lock (Source of Truth):** [FOUNDATION_LOCK.md](./FOUNDATION_LOCK.md) (🔒 **LOCKED** - Foundation CLOSED)
- **Token Types:** `src/tokens/types/index.ts` (🔒 **LOCKED**)
- **Token System:** [Token System Documentation](./TOKEN_AUTHORITY.md) (🔒 **LOCKED**)
...
- **Other Authority Contracts:**
  - [Interaction Authority Contract](./INTERACTION_AUTHORITY.md) (🔒 **LOCKED**)
  - [State Authority Matrix](./STATE_MATRIX.md) (🔒 **LOCKED**)
  - [State Authority Contract](./STATE_AUTHORITY.md) (🔒 **LOCKED**)
  - [Layout Authority Contract](./LAYOUT_AUTHORITY.md) (🔒 **LOCKED**)
  - [Interactive Size Scale Authority Contract](./INTERACTIVE_SIZE_SCALE_AUTHORITY_CONTRACT.md) (🔒 **LOCKED**)
  - [Extension Authority Contract](./EXTENSION_AUTHORITY.md) (✅ **ACTIVE**)
- **Responsive Types:** `src/types/responsive.ts`
- **Responsive Utilities:** `src/lib/responsive-props.ts`
- **Architecture Lock:** [Architecture Lock](./ARCHITECTURE_LOCK.md) (🔒 **LOCKED**)
- **Component Rules:** `docs/architecture/ASSISTANT_DEVELOPMENT_RULES.md`
- **Linting Rules:** `docs/architecture/LINTING_STANDARD.md`
- **Typing Standard:** `docs/reference/TYPING_STANDARD.md` - **MANDATORY** architectural standard for public API typing (REQUIRED, ENFORCED, PRIMARY AUTHORITY)
- **General TypeScript Rules:** `docs/reference/TYPESCRIPT_GENERAL_RULES.md` - General TypeScript implementation rules (SECONDARY GUIDANCE, does not override `TYPING_STANDARD.md`)
