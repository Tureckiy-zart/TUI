...
| HoverCard | `src/PATTERNS/menus/hover-card/` | PROCESS LOCKED | ✅ | ✅ Complete | FULL_0_12_COMPLETE |
...
| CardBase | `src/PATTERNS/cards/CardBase/` | PROCESS LOCKED | ✅ | ✅ Complete | FULL_0_12_COMPLETE |
| Card | `src/COMPOSITION/layout/Card/` | PROCESS LOCKED | ✅ | ✅ Complete | FULL_0_12_COMPLETE |
| EventCard | `src/PATTERNS/cards/EventCard/` | PROCESS LOCKED | ✅ | ✅ Complete | FULL_0_12_COMPLETE |
| ProfileCard | `src/DOMAIN/auth/ProfileCard.tsx` | PROCESS LOCKED | ✅ | ✅ Complete | FULL_0_12_COMPLETE |
| VenueCard | `src/PATTERNS/cards/VenueCard/` | PROCESS LOCKED | ✅ | ✅ Complete | FULL_0_12_COMPLETE |
| PromoCard | `src/PATTERNS/cards/PromoCard/` | PROCESS LOCKED | ✅ | ✅ Complete | FULL_0_12_COMPLETE |
| CategoryCard | `src/PATTERNS/cards/CategoryCard/` | PROCESS LOCKED | ✅ | ✅ Complete | FULL_0_12_COMPLETE |
| ArtistCard | `src/PATTERNS/cards/ArtistCard/` | PROCESS LOCKED | ✅ | ✅ Complete | FULL_0_12_COMPLETE |
| TicketCard | `src/PATTERNS/cards/TicketCard/` | PROCESS LOCKED | ✅ | ✅ Complete | FULL_0_12_COMPLETE |
| FilterBar | `src/PATTERNS/filters/FilterBar.tsx` | PROCESS LOCKED | ✅ | ✅ Complete | FULL_0_12_COMPLETE |
