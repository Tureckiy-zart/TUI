...
**Canonical Sync Date:** 2025-12-19
...
**Source of Truth:** This document reflects the actual public API exported from `src/index.ts`.

**Foundation Components:** See [FOUNDATION_LOCK.md](../architecture/FOUNDATION_LOCK.md) for Foundation component lock status and immutability rules.

**Extension Components:** See [EXTENSION_STATE.md](../architecture/EXTENSION_STATE.md) for complete Extension layer component classification (ALLOWED/RESTRICTED/INTERNAL).
...
See [EXTENSION_STATE.md](../architecture/EXTENSION_STATE.md) for complete component classification rules (ALLOWED/RESTRICTED/INTERNAL).

All components listed in this document are **ALLOWED** and exported via `src/index.ts`. If a component is not listed here, it is RESTRICTED or INTERNAL.

---

## Design Tokens

See [TOKENS_OVERVIEW.md](./TOKENS_OVERVIEW.md) for complete token system documentation and architecture.
